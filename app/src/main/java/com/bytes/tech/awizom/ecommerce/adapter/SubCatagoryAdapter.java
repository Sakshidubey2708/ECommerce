...
public class SubCatagoryAdapter extends  RecyclerView.Adapter<SubCatagoryAdapter.OrderItemViewHolder> {
    ...
    @NonNull
    @Override
    public SubCatagoryAdapter.OrderItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adapter, null);
        return new SubCatagoryAdapter.OrderItemViewHolder(view, mCtx, catagoriesModelList);
    }

    @Override
    public void onBindViewHolder(@NonNull final SubCatagoryAdapter.OrderItemViewHolder holder, int position) {
