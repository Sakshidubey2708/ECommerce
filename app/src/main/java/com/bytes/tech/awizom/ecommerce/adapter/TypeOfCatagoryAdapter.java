...
public class TypeOfCatagoryAdapter extends  RecyclerView.Adapter<TypeOfCatagoryAdapter.OrderItemViewHolder> {
    ...
    @NonNull
    @Override
    public TypeOfCatagoryAdapter.OrderItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adapter, null);
        return new TypeOfCatagoryAdapter.OrderItemViewHolder(view, mCtx, catagoriesModelList);
    }

    @Override
    public void onBindViewHolder(@NonNull final TypeOfCatagoryAdapter.OrderItemViewHolder holder, int position) {
